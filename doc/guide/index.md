...
* 版本：2.0.0
* 作者：圆影
* demo：[http://kg.kissyui.com/number-range/2.0.0/demo/index.html](http://kg.kissyui.com/number-range/2.0.0/demo/index.html)

## 初始化组件
        
    S.use('kg/number-range/2.0.0/index', function (S, NumberRange) {
